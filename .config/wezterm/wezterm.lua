...
wezterm.on("open-htop", function(win, pane)
    win:perform_action(wezterm.action{ SplitVertical = { domain = "CurrentPaneDomain", args = { "htop", "-ps", }, }, }, pane)
end)
...
return {
	...
	keys = {
        ...
        -- 
        -- https://blog.katsyoshi.org/blog/2022/03/19/hello-wezterm/
        { key = "p", mods = "LEADER", action = wezterm.action({ EmitEvent = "open-htop" })},
	},
}